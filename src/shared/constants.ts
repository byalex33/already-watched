...
export const DEFAULT_SETTINGS: Readonly<Settings> = Object.freeze({
  ...
  useYouTubeProgress: true, applyToShorts: true, showWatchedDate: true, hidePromotionalSections: false, hideHomeShorts: false, hideSearchShorts: true, hidePlaylists: false, minimumViews: 0, blockedTitleTerms: []
});
